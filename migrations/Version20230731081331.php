...
final class Version20230731081331 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE memory (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, price INT DEFAULT NULL, speed VARCHAR(255) NOT NULL, modules VARCHAR(255) NOT NULL, price_per_gb INT DEFAULT NULL, color VARCHAR(255) DEFAULT NULL, first_word_latency INT NOT NULL, cas_latency INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
